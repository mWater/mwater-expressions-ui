...
module.exports = ExprLinkComponent = function () {
  var ExprLinkComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(ExprLinkComponent, _React$Component);

    var _super = _createSuper(ExprLinkComponent);

    function ExprLinkComponent(props) {
      var _this;

      (0, _classCallCheck2["default"])(this, ExprLinkComponent);
      _this = _super.call(this, props); // Opens the editor modal

      _this.showModal = _this.showModal.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleClick = _this.handleClick.bind((0, _assertThisInitialized2["default"])(_this)); // Display placeholder if no value. If readonly, use "None" instead of "Select..."

      _this.renderNone = _this.renderNone.bind((0, _assertThisInitialized2["default"])(_this)); // Display summary if field

      _this.renderField = _this.renderField.bind((0, _assertThisInitialized2["default"])(_this));
      _this.renderLiteral = _this.renderLiteral.bind((0, _assertThisInitialized2["default"])(_this));
      _this.state = {
        modalVisible: false
      };
      return _this;
