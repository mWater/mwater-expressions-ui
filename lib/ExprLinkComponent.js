var ExprLinkComponent, ExprUtils, LinkComponent, LiteralExprStringComponent, PropTypes, R, React, SelectExprModalComponent, _,
...
module.exports = ExprLinkComponent = (function(superClass) {
  ...
  function ExprLinkComponent(props) {
    ...
    ExprLinkComponent.__super__.constructor.call(this, props);
    this.state = {
      modalVisible: false
    };
  }
