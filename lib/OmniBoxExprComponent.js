var ClickOutHandler, DateTimePickerComponent, DropdownComponent, ExprUtils, FloatAffixed, H, LinkComponent, OmniBoxExprComponent, R, React, ScalarExprTreeBuilder, ScalarExprTreeComponent, _, isDescendant, moment,
...
module.exports = OmniBoxExprComponent = (function(superClass) {
  ...
  OmniBoxExprComponent.prototype.render = function() {
    ...
    if (this.state.focused) {
      ...
      if (dropdown) {
        dropdown = R(FloatAffixed, null, H.div({
          style: {
