var ClickOutHandler, DropdownComponent, H, LinkComponent, OmniBoxExprComponent, R, React, ScalarExprTreeBuilder, ScalarExprTreeComponent, _,
...
module.exports = OmniBoxExprComponent = (function(superClass) {
  ...
  OmniBoxExprComponent.prototype.handleBlur = function() {
    ...
    if (this.state.mode === "literal") {
      if ((this.props.value && this.props.value.valueType === "text") || this.props.type === "text") {
        return this.props.onChange({
          type: "literal",
          valueType: "text",
          value: this.state.inputText
        });
      } else if ((this.props.value && this.props.value.valueType === "number") || this.props.type === "number") {
  ...
  OmniBoxExprComponent.prototype.renderLiteralDropdown = function() {
    ...
    if ((this.props.value && this.props.value.valueType === "enum") || (this.props.type === "enum")) {
      ...
      dropdown = _.map(this.props.enumValues, (function(_this) {
        return function(ev) {
          if (filter && !ev.name.match(filter)) {
            return null;
          }
          return H.li({
            key: ev.id
    ...
    if ((this.props.value && this.props.value.valueType === "date") || (this.props.type === "date")) {
      return "THIS SHOULD BE A CALENDAR";
    }
    if ((this.props.value && this.props.value.valueType === "datetime") || (this.props.type === "datetime")) {
  ...
  OmniBoxExprComponent.prototype.renderFormulaDropdown = function() {
    var dropdown, escapeRegex, filter, tree, treeBuilder, types;
    dropdown = [];
    dropdown.push(H.div({
      key: "special"
    }, H.a({
    ...
    if (this.props.type !== "enum") {
      ...
      types = this.props.type ? [this.props.type] : void 0;
