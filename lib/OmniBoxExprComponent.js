...
module.exports = OmniBoxExprComponent = (function(superClass) {
  ...
  OmniBoxExprComponent.prototype.handleClickOut = function() {
    if (!this.state.focused) {
      return;
    }
    return this.setState({
  ...
  OmniBoxExprComponent.prototype.handleBlur = function() {
    ...
    if (this.state.mode === "literal") {
      ...
      if ((this.props.value && this.props.value.valueType === "text") || indexOf.call(this.props.types || ['text'], "text") >= 0) {
        return this.props.onChange({
          type: "literal",
          valueType: "text",
          value: this.state.inputText
        });
      } else if ((this.props.value && this.props.value.valueType === "number") || indexOf.call(this.props.types || ['number'], "number") >= 0) {
