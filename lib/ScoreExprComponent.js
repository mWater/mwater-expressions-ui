...
module.exports = ScoreExprComponent = function () {
  var ScoreExprComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(ScoreExprComponent, _React$Component);

    var _super = _createSuper(ScoreExprComponent);
    ...
    function ScoreExprComponent() {
      ...
      _this.handleScoreChange = _this.handleScoreChange.bind((0, _assertThisInitialized2["default"])(_this));
      return _this;
    }
