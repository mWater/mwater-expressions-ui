...
declare let _OptionListComponent: {
    new (props: {} | Readonly<{}>): {
...
declare let _ToggleEditComponent: {
    new (props: any): {
        close: () => void;
        open: () => void;
        handleToggle: () => void;
        ...
        render(): React.CElement<{
            views: {
                editor: any;
                link: React.CElement<import("./LinkComponent").LinkComponentProps, LinkComponent>;
            };
            viewId: string;
        }, React.Component<{
            views: {
...
declare let _ButtonToggleComponent: {
    new (props: {} | Readonly<{}>): {
        render(): React.DetailedReactHTMLElement<{
            className: string;
        }, HTMLElement>;
