var EnumSetComponent, ExprElementBuilder, ExprUtils, H, IdLiteralComponent, LinkComponent, OmniBoxExprComponent, R, React, StackedComponent, TextArrayComponent, WrappedLinkComponent, _,
...
module.exports = ExprElementBuilder = (function() {
  ...
  ExprElementBuilder.prototype.buildScalar = function(expr, onChange, options) {
    ...
    if (expr.expr && ((ref1 = expr.expr.type) === "field" || ref1 === "id")) {
      summary = joinsStr + this.exprUtils.summarizeExpr(expr.expr);
      return H.div({
        style: {
          display: "flex",
          alignItems: "baseline"
