var BuildEnumsetExprComponent, ExprElementBuilder, ExprLinkComponent, ExprUtils, IdLiteralComponent, LinkComponent, PropTypes, R, React, ScoreExprComponent, StackedComponent, WrappedLinkComponent, _,
...
module.exports = ExprElementBuilder = (function() {
  function ExprElementBuilder(schema, dataSource, locale, variables) {
    if (variables == null) {
      variables = [];
    }
    this.schema = schema;
  ...
  ExprElementBuilder.prototype.buildVariable = function(expr, onChange, options) {
    if (options == null) {
      options = {};
    }
    return R(LinkComponent, {
