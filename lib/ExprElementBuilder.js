...
function () {
  ...
  (0, _createClass2.default)(ExprElementBuilder, [{
    ...
    value: function build(expr, table, onChange) {
      ...
      anyTypeAllowed = !options.types || indexOf.call(options.types, "boolean") >= 0 && indexOf.call(options.aggrStatuses, "individual") >= 0 && options.types.length === 1 || indexOf.call(options.types, "number") >= 0 && indexOf.call(options.aggrStatuses, "aggregate") >= 0; // Get current expression type
      ...
      switch (expr.op) {
        ...
        default:
          ...
          if (expr.op === "between") {
            ...
            rhsElem = [this.build(expr.exprs[1], table, rhs1OnChange, {
              ...
              aggrStatuses: innerAggrStatuses,
              key: "expr1"
            }), "\xA0and\xA0", this.build(expr.exprs[2], table, rhs2OnChange, {
    ...
    value: function buildCase(expr, onChange, options) {
      ...
      items = _.map(expr.cases, function (cse, i) {
        ...
        elem = R('div', {
          ...
          key: "label",
          style: labelStyle
        }, "if"), _this2.build(cse.when, expr.table, innerElemOnWhenChange, {
          key: "content",
          types: ["boolean"],
          suppressWrapOps: ["if"],
          aggrStatuses: options.aggrStatuses
          ...
          key: "label",
          style: labelStyle
        }, "then"), _this2.build(cse.then, expr.table, innerElemOnThenChange, {
          key: "content",
          types: options.types,
          preferLiteral: true,
          enumValues: options.enumValues,
