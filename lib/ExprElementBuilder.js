...
module.exports = ExprElementBuilder = (function() {
  ...
  ExprElementBuilder.prototype.buildScalar = function(expr, onChange, options) {
    var aggr, aggrElem, aggrs, destTable, innerElem, innerOnChange, j, join, joinCol, joinsStr, len, ref, ref1, summary;
    if (options == null) {
      options = {};
    }
    if (expr.aggr) {
  ...
  ExprElementBuilder.prototype.buildOp = function(expr, table, onChange, options) {
    var items, lhsElem, lhsOnChange, opElem, opItem, opItems, rhs1OnChange, rhs2OnChange, rhsElem, rhsOnChange;
    if (options == null) {
      options = {};
    }
    switch (expr.op) {
