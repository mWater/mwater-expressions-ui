  ...
  (0, _createClass2["default"])(ExprElementBuilder, [{
    ...
    value: function build(expr, table, onChange) {
      ...
      if (!expr || !expr.type || expr.type === "literal" || expr.type === "field") {
        ...
        elem = this.buildSpatialJoin(expr, onChange, {
          key: options.key,
          type: options.types
        });
        ...
        elem = extension.createExprElement(expr, onChange, this.schema, this.dataSource, this.variables || [], {
          locale: this.locale
        });
      } else {
    ...
    key: "buildSpatialJoin",
    value: function buildSpatialJoin(expr, onChange, options) {
      var BuildSpatialJoinExprComponent;
