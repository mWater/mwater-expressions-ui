...
ExprLinkComponent = require('./ExprLinkComponent'); // Builds a react element for an expression

module.exports = ExprElementBuilder =
/*#__PURE__*/
function () {
  ...
  (0, _createClass2.default)(ExprElementBuilder, [{
    ...
    value: function build(expr, table, onChange) {
      ...
      anyTypeAllowed = !options.types || indexOf.call(options.types, "boolean") >= 0 && (indexOf.call(options.aggrStatuses, "individual") >= 0 || indexOf.call(options.aggrStatuses, "literal") >= 0) && options.types.length === 1 || indexOf.call(options.types, "number") >= 0 && indexOf.call(options.aggrStatuses, "aggregate") >= 0; // Get current expression type
    ...
    value: function buildScalar(expr, onChange) {
      ...
      if (expr.expr && ((ref1 = expr.expr.type) === "field" || ref1 === "id")) {
        ...
        return R('div', {
          style: {
            display: "flex",
            alignItems: "baseline" // Aggregate dropdown
      ...
      switch (expr.op) {
        ...
        case "/":
          ...
          items = _.map(expr.exprs, function (innerExpr, i) {
            ...
            elem = _this.build(innerExpr, table, onChange ? innerElemOnChange : void 0, {
              types: types,
              aggrStatuses: options.aggrStatuses,
    ...
    value: function buildCase(expr, onChange, options) {
      ...
      items = _.map(expr.cases, function (cse, i) {
        ...
        elem = R('div', {
          ...
          key: "label",
          style: labelStyle
        }, "if"), _this2.build(cse.when, expr.table, onChange ? innerElemOnWhenChange : void 0, {
          key: "content",
          types: ["boolean"],
          suppressWrapOps: ["if"],
          aggrStatuses: options.aggrStatuses
          ...
          key: "label",
          style: labelStyle
        }, "then"), _this2.build(cse.then, expr.table, onChange ? innerElemOnThenChange : void 0, {
          key: "content",
          types: options.types,
          preferLiteral: true,
          enumValues: options.enumValues,
...
WrappedLinkComponent = function () {
  ...
  function (_React$Component) {
    ...
    function WrappedLinkComponent() {
      ...
      return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(WrappedLinkComponent).apply(this, arguments));
    }
