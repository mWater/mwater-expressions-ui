...
module.exports = ExprElementBuilder = (function() {
  ...
  ExprElementBuilder.prototype.buildScalar = function(expr, onChange, options) {
    var aggr, aggrElem, aggrs, innerElem, innerOnChange, j, join, joinCol, joinsStr, len, ref, ref1, summary, t;
    if (options == null) {
      options = {};
    }
    if (expr.aggr) {
    ...
    if (expr.expr && ((ref1 = expr.expr.type) === "field" || ref1 === "id")) {
      ...
      innerElem = this.build(expr.expr, (expr.expr ? expr.expr.table : void 0), innerOnChange, {
        types: options.types
      });
    }
    return H.div({
