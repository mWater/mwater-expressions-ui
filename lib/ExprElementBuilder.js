...
class ExprElementBuilder {
    ...
    build(expr, table, onChange, options = {}) {
        ...
        if (!expr || !expr.type || expr.type === "literal" || expr.type === "field") {
            ...
            elem = this.buildOp(expr, table, onChange, Object.assign(Object.assign({}, options), { aggrStatuses: options.aggrStatuses }));
            ...
            const extension = lodash_1.default.findWhere((0, extensions_1.getExprUIExtensions)(), { id: expr.extension });
            if (!extension) {
        ...
        function createWrapOp(op, name, type = "unary") {
            if (!onChange) {
                return;
            }
                ...
                if (type === "unary") {
                    ...
                    links.push({
                        ...
                        onClick: () => {
                            ...
                            exprs.push(null);
                            onChange(Object.assign(Object.assign({}, expr), { exprs }));
                        }
                    });
                }
            }
        ...
        if (expr && expr.type === "case") {
            links.push({
                ...
                onClick: () => {
                    ...
                    onChange(Object.assign(Object.assign({}, expr), { cases }));
                }
            });
        }
        const exprTable = expr ? expr.table : undefined;
                ...
                onClick: () => {
                    const newExpr = {
                        ...
                        cases: lodash_1.default.map(this.exprUtils.getExprEnumValues(expr), (ev) => {
                            ...
                            return {
                                when: { type: "op", table: exprTable, op: "=", exprs: [expr, literal] },
    ...
    buildScalar(expr, onChange, options = {}) {
        ...
        return R("div", { style: { display: "flex", alignItems: "baseline" }, key: options.key }, R(LinkComponent_1.default, {
            dropdownItems: onChange
                ? [{ id: "remove", name: [R("i", { className: "fa fa-remove text-muted" }), " Remove"] }]
                : undefined,
            onDropdownItemClicked: () => onChange(null)
    ...
    buildOp(expr, table, onChange, options) {
        ...
        switch (expr.op) {
            ...
            case "concat":
                ...
                return R("div", null, R(RemovableComponent_1.default, { onRemove: () => onChange(null) }, opItem2.name + ":"), R("div", { style: { display: "inline-block", minWidth: 200 } }, R(ListEditorComponent_1.ListEditorComponent, {
                    items: expr.exprs,
                    onItemsChange: (exprs) => onChange(Object.assign(Object.assign({}, expr), { exprs: exprs })),
                    renderItem: (item, index, onItemChange) => this.build(item, table, onItemChange, Object.assign(Object.assign({}, options), { types: [opItem2.exprTypes[0]] })),
                    createNew: () => null
                })));
            default:
                ...
                if (expr.op === "between") {
                    ...
                    rhsElem = [
                        this.build(expr.exprs[1], table, onChange ? rhs1OnChange : undefined, {
                            ...
                            enumValues: (_a = this.exprUtils.getExprEnumValues(expr.exprs[0])) !== null && _a !== void 0 ? _a : undefined,
                            idTable: (_b = this.exprUtils.getExprIdTable(expr.exprs[0])) !== null && _b !== void 0 ? _b : undefined,
                        ...
                        this.build(expr.exprs[2], table, onChange ? rhs2OnChange : undefined, {
                            ...
                            enumValues: (_c = this.exprUtils.getExprEnumValues(expr.exprs[0])) !== null && _c !== void 0 ? _c : undefined,
                            idTable: (_d = this.exprUtils.getExprIdTable(expr.exprs[0])) !== null && _d !== void 0 ? _d : undefined,
                            refExpr: expr.exprs[0],
                            preferLiteral: true,
                            aggrStatuses: innerAggrStatuses,
                            key: "expr2"
                    ...
                    rhsElem = this.build(expr.exprs[1], table, onChange ? rhsOnChange : undefined, {
                        ...
                        enumValues: ["enum", "enumset"].includes(opItem.exprTypes[1])
                            ...
                            : undefined,
                        idTable: (_e = this.exprUtils.getExprIdTable(expr.exprs[0])) !== null && _e !== void 0 ? _e : undefined,
                        refExpr: expr.exprs[0],
    ...
    buildCase(expr, onChange, options) {
        ...
        const items = lodash_1.default.map(expr.cases, (cse, i) => {
            ...
            const innerElemOnWhenChange = (newWhen) => {
                ...
                onChange(lodash_1.default.extend({}, expr, { cases }));
            };
        ...
        const onElseChange = (newValue) => {
            onChange(lodash_1.default.extend({}, expr, { else: newValue }));
        };
        items.push({
        ...
        // Create stacked expression
        return R(StackedComponent_1.default, { key: options.key, items });
    }
