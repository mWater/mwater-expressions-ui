var EnumSetComponent, ExprElementBuilder, ExprUtils, H, LinkComponent, OmniBoxExprComponent, R, React, StackedComponent, TextArrayComponent, WrappedLinkComponent,
...
module.exports = ExprElementBuilder = (function() {
  ...
  ExprElementBuilder.prototype.build = function(expr, table, onChange, options) {
    var booleanOnly, createWrapOp, elem, exprType, exprTypes, innerOnChange, links;
    if (options == null) {
      options = {};
    }
    ...
    if (exprType) {
      ...
      if (exprTypes && exprTypes.length === 1) {
