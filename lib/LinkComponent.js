...
class LinkComponent extends react_1.default.Component {
    ...
    render() {
        ...
        const elem = R("div", { className: "link-component", "data-bs-toggle": this.props.dropdownItems ? "dropdown" : undefined }, R("div", { style: { display: "inline-block" }, onClick: this.props.onClick }, this.props.children), this.renderRemove());
        // If dropdown
