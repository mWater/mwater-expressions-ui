...
var SpatialJoinPopupContents = function (props) {
    ...
    return react_1.default.createElement("div", null,
        ...
        value.toTable ?
            ...
            : null,
        value.toTable ?
            react_1.default.createElement(bootstrap_1.FormGroup, { label: "Maximum distance (meters)" },
                react_1.default.createElement(bootstrap_1.NumberInput, { value: value.radius, decimal: true, onChange: function (v) { return props.onChange(__assign(__assign({}, value), { radius: v })); } }))
            : null,
        value.toTable ?
