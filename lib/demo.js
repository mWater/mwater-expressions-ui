...
(0, jquery_1.default)(() => jquery_1.default.getJSON("https://api.mwater.co/v3/jsonql/schema", function (schemaJson) {
    ...
    react_dom_1.default.render(R(PropertyListContainerComponentWrapped, { schema: schema, dataSource: dataSource, table: "entities.water_system" }), document.getElementById("main"));
