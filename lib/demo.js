...
$(function() {
  return ReactDOM.render(R(MockTestInlineExprsEditorComponent), document.getElementById("main"));
});
...
PropertyListContainerComponent = (function(superClass) {
  ...
  function PropertyListContainerComponent() {
    PropertyListContainerComponent.__super__.constructor.apply(this, arguments);
    this.state = {
...
MockPropertyEditorTestComponent = (function(superClass) {
  ...
  function MockPropertyEditorTestComponent() {
    this.handleValueChange = bind(this.handleValueChange, this);
    MockPropertyEditorTestComponent.__super__.constructor.apply(this, arguments);
    this.state = {
      value: null,
      schema: null,
      dataSource: null
