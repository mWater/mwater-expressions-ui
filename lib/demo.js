...
mwater_expressions_3.registerExprExtension("test", {
    cleanExpr: (expr) => expr,
...
extensions_1.registerExprUIExtension({
    id: "test",
...
jquery_1.default(() => jquery_1.default.getJSON("https://api.mwater.co/v3/jsonql/schema", function (schemaJson) {
    ...
    return react_dom_1.default.render(R(MockTestComponent), document.getElementById("main"));
}));
...
const PropertyListContainerComponentWrapped = react_dnd_1.DragDropContext(react_dnd_html5_backend_1.default)(PropertyListContainerComponent);
