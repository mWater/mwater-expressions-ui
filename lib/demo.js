...
var $,
    ...
    LiveIdLiteralTestComponent,
    LiveTestComponent,
    MWaterDataSource,
    MockPropertyEditorTestComponent,
    MockTestComponent,
    MockTestInlineExprsEditorComponent,
    ModalPopupComponent,
    PropTypes,
    PropertyListComponent,
    PropertyListContainerComponent,
    PropertyListContainerComponentWrapped,
    R,
    React,
    ReactDOM,
    Schema,
...
registerExprExtension("test", {
  cleanExpr: function cleanExpr(expr) {
    return expr;
  },
  getExprAggrStatus: function getExprAggrStatus() {
    return "individual";
  },
  validateExpr: function validateExpr(expr) {
    return null;
  },
  getExprEnumValues: function getExprEnumValues(expr) {
    return [];
  },
  getExprIdTable: function getExprIdTable(expr) {
    return null;
  },
  getExprType: function getExprType(expr) {
    return "number";
  },
  summarizeExpr: function summarizeExpr(expr) {
    return "EXTENSION: ".concat(expr.params.value);
  },
  getReferencedFields: function getReferencedFields(expr) {
    return [];
  },
  compileExpr: function compileExpr(expr) {
    throw new Error("Not implemented");
  },
  evaluate: function evaluate(expr) {
    throw new Error("Not implemented");
  },
  evaluateSync: function evaluateSync(expr) {
    throw new Error("Not implemented");
  }
});
registerExprUIExtension({
  ...
  desc: {
    _base: "en",
    en: "Extension for advanced use"
  },
  aggrStatuses: ["individual"],
  types: ["number"],
  createDefaultExpr: function createDefaultExpr(table) {
    return {
      type: "extension",
      extension: "test",
      table: table,
  ...
  createExprElement: function createExprElement(expr, onExprChange, schema, dataSource, variables, locale) {
    return R('div', null, "EXTENSION: ".concat(expr.params.value));
  }
});
$(function () {
  return $.getJSON("https://api.mwater.co/v3/jsonql/schema", function (schemaJson) {
    ...
    dataSource = new MWaterDataSource("https://api.mwater.co/v3/", null, false); // ReactDOM.render(R(MockTestInlineExprsEditorComponent), document.getElementById("main"))
...
PropertyListContainerComponent = function () {
  ...
  var PropertyListContainerComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(PropertyListContainerComponent, _React$Component);

    var _super = _createSuper(PropertyListContainerComponent);

    function PropertyListContainerComponent(props) {
      var _this;

      (0, _classCallCheck2["default"])(this, PropertyListContainerComponent);
      _this = _super.call(this, props);
      _this.state = {
        properties: _this.props.schema.getTable("entities.water_system").contents
      };
      return _this;
    }

    (0, _createClass2["default"])(PropertyListContainerComponent, [{
      key: "render",
...
ContentEditableTestComponent = /*#__PURE__*/function (_React$Component2) {
  (0, _inherits2["default"])(ContentEditableTestComponent, _React$Component2);

  var _super2 = _createSuper(ContentEditableTestComponent);

  function ContentEditableTestComponent(props) {
    var _this3;

    (0, _classCallCheck2["default"])(this, ContentEditableTestComponent);
  ...
  (0, _createClass2["default"])(ContentEditableTestComponent, [{
    key: "render",
    value: function render() {
      var _this4 = this;
      ...
      return R('div', null, R('div', null, "Sdfsdfsd"), R('div', null, "Sdfsdfsd"), R(ContentEditableComponent, {
        ...
        onClick: function onClick() {
          console.log("click!");
          return _this4.editor.pasteHTML("<b>" + _this4.editor.getSelectedHTML() + "</b>");
        },
        type: "button"
      }, "Paste"));
    }
...
MockTestInlineExprsEditorComponent = /*#__PURE__*/function (_React$Component3) {
  (0, _inherits2["default"])(MockTestInlineExprsEditorComponent, _React$Component3);

  var _super3 = _createSuper(MockTestInlineExprsEditorComponent);

  function MockTestInlineExprsEditorComponent(props) {
    var _this5;

    (0, _classCallCheck2["default"])(this, MockTestInlineExprsEditorComponent);
  ...
  (0, _createClass2["default"])(MockTestInlineExprsEditorComponent, [{
    ...
    value: function componentWillMount() {
      ...
      dataSource = {
        performQuery: function performQuery(query, cb) {
          return cb(null, [{
            value: "abc"
          }, {
            value: "xyz"
    ...
    key: "handleChange",
    value: function handleChange(text, exprs) {
      boundMethodCheck(this, MockTestInlineExprsEditorComponent);
      console.log("handleChange: ".concat(text));
      return this.setState({
        text: text,
        exprs: exprs
      });
...
}(React.Component); // R('br')
// R('br')
// R 'pre', null, JSON.stringify(@state.value, null, 2)


MockTestComponent = /*#__PURE__*/function (_React$Component4) {
  (0, _inherits2["default"])(MockTestComponent, _React$Component4);

  var _super4 = _createSuper(MockTestComponent);

  function MockTestComponent(props) {
    var _this6;

    (0, _classCallCheck2["default"])(this, MockTestComponent);
    _this6 = _super4.call(this, props);
    _this6.handleValueChange = _this6.handleValueChange.bind((0, _assertThisInitialized2["default"])(_this6));
    _this6.state = {
      value: null,
  ...
  (0, _createClass2["default"])(MockTestComponent, [{
    key: "componentWillMount",
    value: function componentWillMount() {
      var dataSource, schema;
      schema = new Schema();
    ...
    value: function handleValueChange(value) {
      boundMethodCheck(this, MockTestComponent); // value = new ExprCleaner(@state.schema).cleanExpr(value) #, { type: 'boolean' })
...
MockPropertyEditorTestComponent = /*#__PURE__*/function (_React$Component5) {
  (0, _inherits2["default"])(MockPropertyEditorTestComponent, _React$Component5);

  var _super5 = _createSuper(MockPropertyEditorTestComponent);

  function MockPropertyEditorTestComponent(props) {
    var _this7;

    (0, _classCallCheck2["default"])(this, MockPropertyEditorTestComponent);
    _this7 = _super5.call(this, props);
    _this7.handleValueChange = _this7.handleValueChange.bind((0, _assertThisInitialized2["default"])(_this7));
    _this7.state = {
      value: null,
      // { type: "field", table: "t1", column: "1-2" }
      schema: null,
  ...
  (0, _createClass2["default"])(MockPropertyEditorTestComponent, [{
    key: "componentWillMount",
    value: function componentWillMount() {
      var dataSource, schema;
      schema = new Schema();
    ...
    key: "handleValueChange",
    value: function handleValueChange(value) {
      boundMethodCheck(this, MockPropertyEditorTestComponent); // value = new ExprCleaner(@state.schema).cleanExpr(value) #, { type: 'boolean' })
...
LiveTestComponent = /*#__PURE__*/function (_React$Component6) {
  (0, _inherits2["default"])(LiveTestComponent, _React$Component6);

  var _super6 = _createSuper(LiveTestComponent);

  function LiveTestComponent(props) {
    var _this8;

    (0, _classCallCheck2["default"])(this, LiveTestComponent);
    _this8 = _super6.call(this, props);
    _this8.handleValueChange = _this8.handleValueChange.bind((0, _assertThisInitialized2["default"])(_this8));
    _this8.state = {
      value: null,
      schema: null,
      dataSource: null
  ...
  (0, _createClass2["default"])(LiveTestComponent, [{
    key: "componentWillMount",
    value: function componentWillMount() {
      var _this9 = this;

      var apiUrl; // apiUrl = "http://localhost:1234/v3/"

      apiUrl = "https://api.mwater.co/v3/";
      return $.getJSON(apiUrl + "jsonql/schema", function (schemaJson) {
        var dataSource, schema;
        schema = new Schema(schemaJson);
    ...
    key: "handleValueChange",
    value: function handleValueChange(value) {
      boundMethodCheck(this, LiveTestComponent); // value = new ExprCleaner(@state.schema).cleanExpr(value, { aggrStatuses: ['literal', 'aggregate']}) #, { type: 'boolean' })
    ...
    value: function render() {
      ...
      return R('div', {
        ...
        value: this.state.value,
        onChange: this.handleValueChange,
        variables: variables // R(FilterExprComponent, 
        //   schema: @state.schema
        //   dataSource: @state.dataSource
        //   table: "entities.water_point"
        //   value: @state.value
...
MWaterDataSource = /*#__PURE__*/function (_DataSource) {
  (0, _inherits2["default"])(MWaterDataSource, _DataSource);

  var _super7 = _createSuper(MWaterDataSource);
  ...
  function MWaterDataSource(apiUrl, client) {
    ...
    _this10.apiUrl = apiUrl;
    _this10.client = client;
    _this10.caching = caching;
    return _this10;
  }
...
LiveIdLiteralTestComponent = /*#__PURE__*/function (_React$Component7) {
  (0, _inherits2["default"])(LiveIdLiteralTestComponent, _React$Component7);

  var _super8 = _createSuper(LiveIdLiteralTestComponent);

  function LiveIdLiteralTestComponent(props) {
    var _this11;

    (0, _classCallCheck2["default"])(this, LiveIdLiteralTestComponent);
  ...
  (0, _createClass2["default"])(LiveIdLiteralTestComponent, [{
    key: "componentWillMount",
    value: function componentWillMount() {
      var _this12 = this;
    ...
    value: function render() {
      ...
      return R('div', {
      ...
      }, R(ModalPopupComponent, null, R(IdLiteralComponent, {
        value: null,
        ...
        idTable: "admin_regions",
        schema: this.state.schema,
        dataSource: this.state.dataSource // R(FilterExprComponent, 
        //   schema: @state.schema
        //   dataSource: @state.dataSource
        //   table: "entities.water_point"
        //   value: @state.value
  ...
  return LiveIdLiteralTestComponent;
}(React.Component);