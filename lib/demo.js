...
$(function() {
  return $.getJSON("https://api.mwater.co/v3/jsonql/schema", function(schemaJson) {
    ...
    return ReactDOM.render(R(ContentEditableTestComponent), document.getElementById("main"));
  });
});
  ...
  class PropertyListContainerComponent extends React.Component {
    ...
    render() {
      return H.div({
        ...
        createRoleDisplayElem: (roles) => {
          return H.span(null, JSON.stringify(roles));
        },
        ...
        className: "col-md-6"
      }, H.pre(null, JSON.stringify(this.state.properties, null, 2))));
    }
...
ContentEditableTestComponent = class ContentEditableTestComponent extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    return H.div(null, H.div(null, "Sdfsdfsd"), H.div(null, "Sdfsdfsd"), R(ContentEditableComponent, {
      ref: "editor",
    ...
    }), H.div(null, "Sdfsdfsd"), H.button({
      onClick: () => {
        console.log("click!");
        return this.refs.editor.pasteHTML("<b>" + this.refs.editor.getSelectedHTML() + "</b>");
      },
      type: "button"
    }, "Paste"));
  }
...
MockTestInlineExprsEditorComponent = class MockTestInlineExprsEditorComponent extends React.Component {
  constructor(props) {
    super(props);
...
MockTestComponent = class MockTestComponent extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleValueChange(value) {
    boundMethodCheck(this, MockTestComponent);
...
MockPropertyEditorTestComponent = class MockPropertyEditorTestComponent extends React.Component {
  constructor(props) {
    super(props);
    this.handleValueChange = this.handleValueChange.bind(this);
    this.state = {
  ...
  handleValueChange(value) {
    boundMethodCheck(this, MockPropertyEditorTestComponent);
...
LiveTestComponent = class LiveTestComponent extends React.Component {
  constructor(props) {
    super(props);
    this.handleValueChange = this.handleValueChange.bind(this);
    this.state = {
  ...
  handleValueChange(value) {
    boundMethodCheck(this, LiveTestComponent);
