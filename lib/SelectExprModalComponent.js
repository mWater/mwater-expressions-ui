...
class SelectExprModalComponent extends react_1.default.Component {
    renderContents() {
        ...
        return R("div", null, R("h3", { style: { marginTop: 0 } }, "Select Field, Formula or Value"), R(TabbedComponent_1.default, {
            tabs,
...
SelectExprModalComponent.propTypes = {
    ...
    booleanOnly: prop_types_1.default.bool,
    placeholder: prop_types_1.default.string // Placeholder text (default Select...)
};
