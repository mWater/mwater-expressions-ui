  ...
  (0, _createClass2.default)(ScalarExprTreeBuilder, [{
    ...
    value: function createColumnNode(options) {
      ...
      if (column.type === "join") {
        ...
        initVal = options.initialValue; // Do not allow selecting joins if the toTable doesn't have a label field. Otherwise, there is no way to filter it or otherwise manipulate it
