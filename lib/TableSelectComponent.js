...
exports.CustomTableSelectComponentFactoryContext = (0, react_2.createContext)(null);
/** Context to set the locale */
exports.LocaleContext = (0, react_2.createContext)("en");
...
exports.ActiveTablesContext = (0, react_2.createContext)([]);
/** Table select component that uses custom one if available */
const TableSelectComponent = (props) => {
    const value = props.value;
    const customTableSelectComponentFactory = (0, react_2.useContext)(exports.CustomTableSelectComponentFactoryContext);
    const locale = (0, react_2.useContext)(exports.LocaleContext);
...
exports.TableSelectComponent = TableSelectComponent;
