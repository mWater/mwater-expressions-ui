...
PropertyListComponent = function () {
  ...
  var PropertyListComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(PropertyListComponent, _React$Component);

    var _super = _createSuper(PropertyListComponent);
    ...
    function PropertyListComponent(props) {
      ...
      _this.handleNewProperty = _this.handleNewProperty.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleNewSection = _this.handleNewSection.bind((0, _assertThisInitialized2["default"])(_this));
      _this.renderProperty = _this.renderProperty.bind((0, _assertThisInitialized2["default"])(_this));
      _this.state = {
...
PropertyComponent = function () {
  var PropertyComponent = /*#__PURE__*/function (_React$Component2) {
    (0, _inherits2["default"])(PropertyComponent, _React$Component2);

    var _super2 = _createSuper(PropertyComponent);
    ...
    function PropertyComponent(props) {
      ...
      _this4.handleEdit = _this4.handleEdit.bind((0, _assertThisInitialized2["default"])(_this4));
      _this4.renderEnumValues = _this4.renderEnumValues.bind((0, _assertThisInitialized2["default"])(_this4));
      _this4.state = {
        editing: false,
        editorProperty: null
      };
    ...
    (0, _createClass2["default"])(PropertyComponent, [{
      ...
      value: function render() {
        ...
        }), this.props.property.required ? R('span', {
          style: {
            color: "red"
          }
        }, "*") : void 0, this.props.property.expr ? R('span', {
        ...
        }, "SQL: ".concat(this.props.property.sql)) : void 0, this.props.property.reverseSql ? R('div', {
          className: "pl-item-detail-sql text-info"
        }, "Reverse SQL: ".concat(this.props.property.reverseSql)) : void 0, ((ref = this.props.property.type) === "enum" || ref === "enumset") && this.props.property.enumValues.length > 0 ? R('div', {
