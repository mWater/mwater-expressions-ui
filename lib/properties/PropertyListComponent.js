var ActionCancelModalComponent, H, LocalizedStringComponent, NestedListClipboardEnhancement, PropTypes, PropertyComponent, PropertyEditorComponent, PropertyListComponent, R, React, ReorderableListComponent, SectionEditorComponent, _, flattenProperties, uuid,
...
PropertyListComponent = (function(superClass) {
  ...
  PropertyListComponent.prototype.renderControls = function(allPropertyIds) {
    ...
    }, this.renderAddingModal(allPropertyIds), H.button({
      key: "default_add",
      type: "button",
...
PropertyComponent = (function(superClass) {
  ...
  PropertyComponent.prototype.render = function() {
    ...
    }), this.props.property.expr ? H.span({
      className: "text-muted"
    }, " ", H.span({
      className: "fa fa-calculator"
    })) : void 0), this.props.property.desc ? H.div({
