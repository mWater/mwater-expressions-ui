...
class InnerPropertyListComponent extends react_1.default.Component {
    ...
    renderControls(allPropertyIds) {
        ...
        }, R("i", { className: "fa fa-plus" }), " ", "Add"), R("ul", { className: "dropdown-menu", role: "menu" }, R("li", { key: "property" }, R("a", { className: "dropdown-item", onClick: this.handleNewProperty }, "Property")), lodash_1.default.includes(this.props.features || [], "section")
...
class PropertyComponent extends react_1.default.Component {
    constructor(props) {
        ...
        this.renderEnumValues = (values) => {
            const names = lodash_1.default.map(values, (value) => value.name[value.name._base || "en"]);
    ...
    render() {
        ...
        return R("div", { className: `${classNames.join(" ")} pl-item-type-${this.props.property.type}` }, this.state.editing
            ...
            : undefined, this.props.property.roles && this.props.createExtraDisplayElem
