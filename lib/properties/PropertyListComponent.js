...
class PropertyListComponent extends react_1.default.Component {
    ...
    renderControls(allPropertyIds) {
        ...
        }, R("i", { className: "fa fa-plus" }), " ", "Add", " ", R("span", { className: "caret" })), R("ul", { className: "dropdown-menu text-left", role: "menu" }, R("li", { key: "property" }, R("a", { onClick: this.handleNewProperty }, "Property")), lodash_1.default.includes(this.props.features, "section")
...
PropertyListComponent.propTypes = {
    properties: prop_types_1.default.array.isRequired,
    ...
    propertyIdGenerator: prop_types_1.default.func,
    allPropertyIds: prop_types_1.default.arrayOf(prop_types_1.default.string.isRequired),
    ...
    onCut: prop_types_1.default.func,
    onCopy: prop_types_1.default.func,
    onPaste: prop_types_1.default.func,
    onPasteInto: prop_types_1.default.func,
    listId: prop_types_1.default.string // used internally
};
PropertyListComponent.contextTypes = { clipboard: prop_types_1.default.object };
class PropertyComponent extends react_1.default.Component {
    ...
    render() {
        ...
        return R("div", { className: `${classNames.join(" ")} pl-item-type-${this.props.property.type}` }, this.state.editing
            ...
            ? R("div", { className: "pl-item-section" }, R(PropertyListComponent, {
...
exports.default = NestedListClipboardEnhancement_1.default(PropertyListComponent);
