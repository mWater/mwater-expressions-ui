...
PropertyListComponent = (function(superClass) {
  ...
  PropertyListComponent.prototype.handleNewSection = function() {
    ...
    if (_.includes(this.props.features, "idField") && this.props.propertyIdGenerator) {
      section["id"] = this.props.propertyIdGenerator();
    } else {
      section["id"] = uuid.v4();
    }
    return this.setState({
...
PropertyComponent = (function(superClass) {
  ...
  PropertyComponent.prototype.render = function() {
    ...
    return H.div({
      ...
      className: (PropertyComponent.iconMap[this.props.property.type] || "glyphicon glyphicon-property-type-number") + " pull-left"
    }, "")), H.div(null, H.div({
    ...
    }, this.renderEnumValues(this.props.property.enumValues)) : void 0))), this.props.property.type === "section" ? H.div({
