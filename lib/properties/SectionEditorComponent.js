...
module.exports = SectionEditorComponent = (function(superClass) {
  ...
  SectionEditorComponent.prototype.render = function() {
    return H.div(null, _.includes(this.props.features, "idField") ? R(FormGroupComponent, {
      label: "ID"
    }, H.input({
      type: "text",
      className: "form-control",
      value: this.props.property._id,
    ...
    }, "Letters lowercase, numbers and _ only. No spaces or uppercase")) : void 0, R(FormGroupComponent, {
      label: "Code"
    }, H.input({
      type: "text",
      className: "form-control",
