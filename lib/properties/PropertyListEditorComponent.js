var EnumValueEditorComponent, EnumValuesEditorComponent, ExprComponent, H, IdFieldComponent, JoinEditorComponent, LocalizedStringEditorComp, PropertyListEditorComponent, R, React, TableSelectComponent, _, ui,
...
module.exports = PropertyListEditorComponent = (function(superClass) {
  ...
  PropertyListEditorComponent.prototype.render = function() {
    ...
    })) : void 0, _.includes(this.props.features, "expr") && this.props.property.type ? R(ui.FormGroup, {
      label: "Expression",
      hint: "Leave blank unless this property is an expression"
    }, R(ExprComponent, {
    ...
    })), _.includes(this.props.features, "uniqueCode") && this.props.property.type === "text" ? R(ui.FormGroup, {
      label: "Unique Code?"
    }, H.input({
      type: 'checkbox',
