var EnumValueEditorComponent, EnumValuesEditorComponent, ExprComponent, FormGroupComponent, H, IdFieldComponent, JoinEditorComponent, LocalizedStringEditorComp, PropertyListEditorComponent, R, React, TableSelectComponent, _, className,
...
module.exports = PropertyListEditorComponent = (function(superClass) {
  ...
  PropertyListEditorComponent.prototype.render = function() {
    ...
    return H.div(null, _.includes(this.props.features, "idField") ? R(IdFieldComponent, {
    ...
    }) : void 0, _.includes(this.props.features, "idField") ? R(FormGroupComponent, {
      label: "Code"
    }, H.input({
      type: "text",
      ...
      key: "expr",
      value: "expr"
    }, "Expression"), _.includes(this.props.features, "idType") ? H.option({
      key: "id",
      value: "id"
    }, "Reference") : void 0, _.includes(this.props.features, "joinType") ? H.option({
      key: "join",
      value: "join"
    ...
    })) : void 0, this.props.property.type === "id" ? R(FormGroupComponent, {
      label: "ID Table"
...
IdFieldComponent = (function(superClass) {
