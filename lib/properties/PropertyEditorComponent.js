...
JoinEditorComponent = function () {
  // Edits join
  var JoinEditorComponent = /*#__PURE__*/function (_React$Component2) {
    (0, _inherits2["default"])(JoinEditorComponent, _React$Component2);

    var _super2 = _createSuper(JoinEditorComponent);
    ...
    (0, _createClass2["default"])(JoinEditorComponent, [{
      ...
      value: function render() {
        ...
        return R('div', null, R('div', {
          ...
          label: "Inverse. Column (schema, not physical) in 'To Table' that is the reverse of this join. Optional"
        }, R('input', {
          type: 'text',
          className: "form-control",
          value: (ref4 = this.props.value) != null ? ref4.inverse : void 0,
          onChange: function onChange(ev) {
            return _this2.props.onChange(_.extend({}, _this2.props.value, {
              inverse: ev.target.value
            }));
          }
        })))));
      }
...
TableSelectComponent = function () {
  ...
  var TableSelectComponent = /*#__PURE__*/function (_React$Component3) {
    (0, _inherits2["default"])(TableSelectComponent, _React$Component3);

    var _super3 = _createSuper(TableSelectComponent);
...
EnumValuesEditorComponent = function () {
  ...
  var EnumValuesEditorComponent = /*#__PURE__*/function (_React$Component4) {
    (0, _inherits2["default"])(EnumValuesEditorComponent, _React$Component4);

    var _super4 = _createSuper(EnumValuesEditorComponent);
    ...
    function EnumValuesEditorComponent() {
      ...
      _this3.handleAdd = _this3.handleAdd.bind((0, _assertThisInitialized2["default"])(_this3));
      _this3.handleRemove = _this3.handleRemove.bind((0, _assertThisInitialized2["default"])(_this3));
      return _this3;
    }
      ...
      value: function render() {
        ...
        return R('div', null, _.map(this.props.value || [], function (value, i) {
          return R(EnumValueEditorComponent, {
            key: i,
            value: value,
            onChange: _this4.handleChange.bind(null, i),
            onRemove: _this4.handleRemove.bind(null, i)
          });
        }), R('button', {
          type: "button",
...
EnumValueEditorComponent = function () {
  ...
  var EnumValueEditorComponent = /*#__PURE__*/function (_React$Component5) {
    (0, _inherits2["default"])(EnumValueEditorComponent, _React$Component5);

    var _super5 = _createSuper(EnumValueEditorComponent);
    ...
    (0, _createClass2["default"])(EnumValueEditorComponent, [{
      ...
      value: function render() {
        ...
        return R('div', null, R('div', {
          ...
          onChange: function onChange(value) {
            return _this5.props.onChange(_.extend({}, _this5.props.value, {
              id: value
            }));
          }
        })), R('div', {
