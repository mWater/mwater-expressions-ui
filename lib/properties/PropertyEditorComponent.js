  ...
  function (_React$Component) {
    ...
    (0, _createClass2.default)(PropertyEditorComponent, [{
      ...
      value: function render() {
        ...
        }, "Deprecated"), _.includes(this.props.features, "uniqueCode") && this.props.property.type === "text" ? R('input', {
          type: 'checkbox',
        ...
        }, R('label', null, "Unique Code")) : void 0, _.includes(this.props.features, "unique") && ((ref3 = this.props.property.type) === "text" || ref3 === "id") ? R('input', {
          type: 'checkbox',
          checked: this.props.property.unique,
          onChange: function onChange(ev) {
            return _this.props.onChange(_.extend({}, _this.props.property, {
              unique: ev.target.checked
            }));
          }
        }, R('label', null, "Unique Value")) : void 0, _.includes(this.props.features, "sql") ? R(ui.FormGroup, {
          label: "SQL"
        }, R('input', {
          type: 'text',
          className: "form-control",
...
EnumValuesEditorComponent = function () {
  ...
  function (_React$Component4) {
    ...
    function EnumValuesEditorComponent() {
      ...
      _this3 = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(EnumValuesEditorComponent).apply(this, arguments));
      _this3.handleChange = _this3.handleChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this3)));
      _this3.handleAdd = _this3.handleAdd.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this3)));
      _this3.handleRemove = _this3.handleRemove.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this3)));
      return _this3;
    }
