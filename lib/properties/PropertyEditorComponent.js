  ...
  function (_React$Component) {
    ...
    (0, _createClass2.default)(PropertyEditorComponent, [{
      ...
      value: function render() {
        ...
        })) : void 0, this.props.property.type === "measurement" ? R(ui.FormGroup, {
          label: "Units"
        }, R(EnumValuesEditorComponent, {
        ...
        })) : void 0, this.props.property.type !== "measurement" ? _.includes(this.props.features, "expr") && this.props.property.type && (this.props.property.table || this.props.table) ? R(ui.FormGroup, {
          label: "Expression",
        ...
        })) : void 0 : void 0, _.includes(this.props.features, "conditionExpr") && (this.props.property.table || this.props.table) ? R(ui.FormGroup, {
          label: "Condition",
  ...
  function (_React$Component3) {
    ...
    (0, _createClass2.default)(TableSelectComponent, [{
      ...
      value: function render() {
        ...
        }, _.map(this.props.schema.tables, function (table) {
          return R('option', {
            key: table.id,
            value: table.id
  ...
  function (_React$Component4) {
    ...
    (0, _createClass2.default)(EnumValuesEditorComponent, [{
      ...
      value: function render() {
        ...
        }, "+ ".concat(this.props.actionLabel || "Add Value")));
      }
    }]);
