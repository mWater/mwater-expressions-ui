...
module.exports = PropertyEditorComponent = function () {
  var PropertyEditorComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(PropertyEditorComponent, _React$Component);

    var _super = _createSuper(PropertyEditorComponent);
    ...
    (0, _createClass2["default"])(PropertyEditorComponent, [{
      ...
      value: function render() {
        ...
        return R('div', null, _.includes(this.props.features, "table") ? R(ui.FormGroup, {
        ...
        })) : void 0, _.includes(this.props.features, "required") ? R(ui.Checkbox, {
        ...
        }, "Unique Value") : void 0, _.includes(this.props.features, "indexed") && ((ref4 = this.props.property.type) === "text" || ref4 === "id" || ref4 === "number" || ref4 === "enum") ? R(ui.Checkbox, {
        ...
        }, "Indexed (improves query speed, but slows updates)") : void 0, _.includes(this.props.features, "onDelete") && (ref5 = this.props.property.type) === "id" ? R(ui.FormGroup, {
          label: "On Delete"
        }, R(ui.Select, {
          ...
          label: "SQL",
          hint: "Use {alias} for the table alias"
        }, R('input', {
          type: 'text',
          className: "form-control",
        ...
        })) : void 0, _.includes(this.props.features, "reverseSql") ? R(ui.FormGroup, {
          label: "Reverse SQL",
          hint: "Use {value} for the value to convert"
        }, R('input', {
          type: 'text',
          className: "form-control",
...
TableSelectComponent = function () {
  ...
  var TableSelectComponent = /*#__PURE__*/function (_React$Component2) {
    (0, _inherits2["default"])(TableSelectComponent, _React$Component2);

    var _super2 = _createSuper(TableSelectComponent);
...
EnumValuesEditorComponent = function () {
  ...
  var EnumValuesEditorComponent = /*#__PURE__*/function (_React$Component3) {
    (0, _inherits2["default"])(EnumValuesEditorComponent, _React$Component3);

    var _super3 = _createSuper(EnumValuesEditorComponent);
    ...
    function EnumValuesEditorComponent() {
      ...
      _this2.handleMoveUp = _this2.handleMoveUp.bind((0, _assertThisInitialized2["default"])(_this2));
      _this2.handleMoveDown = _this2.handleMoveDown.bind((0, _assertThisInitialized2["default"])(_this2));
      return _this2;
    }
    ...
    (0, _createClass2["default"])(EnumValuesEditorComponent, [{
      ...
      key: "handleMoveDown",
      value: function handleMoveDown(i) {
        var temp, value;
        boundMethodCheck(this, EnumValuesEditorComponent);
        value = (this.props.value || []).slice();
        temp = value[i + 1];
      ...
      value: function render() {
        ...
        return R('div', null, _.map(items, function (value, i) {
          return R(EnumValueEditorComponent, {
            key: i,
            value: value,
            onChange: _this3.handleChange.bind(null, i),
            onRemove: _this3.handleRemove.bind(null, i),
            onMoveUp: i > 0 ? _this3.handleMoveUp.bind(null, i) : void 0,
            onMoveDown: i < items.length - 1 ? _this3.handleMoveDown.bind(null, i) : void 0
          });
        }), R('button', {
          type: "button",
...
EnumValueEditorComponent = function () {
  ...
  var EnumValueEditorComponent = /*#__PURE__*/function (_React$Component4) {
    (0, _inherits2["default"])(EnumValueEditorComponent, _React$Component4);

    var _super4 = _createSuper(EnumValueEditorComponent);
    ...
    (0, _createClass2["default"])(EnumValueEditorComponent, [{
      ...
      value: function render() {
        ...
        }, this.props.onMoveUp ? R('button', {
          className: "btn btn-link btn-xs",
          onClick: this.props.onMoveUp
        }, "Move Up") : void 0, this.props.onMoveDown ? R('button', {
          className: "btn btn-link btn-xs",
          onClick: this.props.onMoveDown
        }, "Move Down") : void 0, this.props.onRemove ? R('button', {
          className: "btn btn-link btn-xs",
