  ...
  return NestedListClipboardEnhancement = function () {
    ...
    function (_React$Component) {
      ...
      function NestedListClipboardEnhancement(props) {
        ...
        _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(NestedListClipboardEnhancement).call(this, props));
        _this.handleCut = _this.handleCut.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
        _this.findItemById = _this.findItemById.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
        _this.handleCopy = _this.handleCopy.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
        _this.handlePasteInto = _this.handlePasteInto.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
        _this.cut = _this.cut.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
        _this.paste = _this.paste.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
        _this.handlePaste = _this.handlePaste.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
        _this.getChildContext = _this.getChildContext.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
        _this.state = {
          clipboard: null
        };
        return _this;
