...
class SelectFormulaExprComponent extends react_1.default.Component {
    ...
    render() {
        ...
        // Add extensions
        for (let exprUIExtension of (0, extensions_1.getExprUIExtensions)()) {
            ;
            ((exprUIExtension) => {
                // Filter types
                ...
                return items.push({
                    ...
                    onClick: () => { var _a; return this.props.onChange(exprUIExtension.createDefaultExpr((_a = this.props.table) !== null && _a !== void 0 ? _a : null)); }
                });
            })(exprUIExtension);
        }
        if (this.state.searchText) {
