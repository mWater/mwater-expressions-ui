...
module.exports = SelectFormulaExprComponent = function () {
  var SelectFormulaExprComponent = /*#__PURE__*/function (_React$Component) {
    ...
    function SelectFormulaExprComponent(props) {
      ...
      _this.handleSpatialJoinSelected = _this.handleSpatialJoinSelected.bind((0, _assertThisInitialized2["default"])(_this));
    ...
    (0, _createClass2["default"])(SelectFormulaExprComponent, [{
      ...
      key: "handleSpatialJoinSelected",
      value: function handleSpatialJoinSelected() {
        var expr;
        boundMethodCheck(this, SelectFormulaExprComponent);
        expr = {
          type: "spatial join",
      ...
      value: function render() {
        ...
        var aggr, exprUIExtension, exprUtils, filter, i, items, j, len, len1, opItem, opItems, ref, ref1;
        ...
        ref1 = getExprUIExtensions(); // # Add spatial join
        // if @props.table
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          exprUIExtension = ref1[j];

          (function (exprUIExtension) {
            // Filter types
            if (exprUIExtension.types && _this2.props.types && _.intersection(exprUIExtension.types, _this2.props.types).length === 0) {
              return;
            } // Filter aggr


            if (_.intersection(exprUIExtension.aggrStatuses, _this2.props.aggrStatuses || ["individual", "literal"]).length === 0) {
              return;
            }

            if (exprUIExtension.table && exprUIExtension.table !== _this2.props.table) {
              return;
            }

            return items.push({
              name: ExprUtils.localizeString(exprUIExtension.name, _this2.props.locale),
              desc: ExprUtils.localizeString(exprUIExtension.desc, _this2.props.locale),
              onClick: function onClick() {
                return _this2.props.onChange(exprUIExtension.createDefaultExpr(_this2.props.table));
              }
            });
          })(exprUIExtension);
        }
