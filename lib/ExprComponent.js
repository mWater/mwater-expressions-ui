...
module.exports = ExprComponent = (function(superClass) {
  ...
  ExprComponent.prototype.render = function() {
    ...
    return new ExprElementBuilder(this.props.schema, this.props.dataSource, this.context.locale, this.props.variables).build(expr, this.props.table, this.handleChange, {
      types: this.props.types,
      ...
      exprLinkRef: !expr ? ((function(_this) {
        return function(c) {
          return _this.exprLink = c;
        };
      })(this)) : void 0
    });
  };
