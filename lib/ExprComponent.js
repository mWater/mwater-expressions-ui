...
module.exports = ExprComponent = function () {
  var ExprComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(ExprComponent, _React$Component);

    var _super = _createSuper(ExprComponent);

    function ExprComponent() {
      var _this;

      (0, _classCallCheck2["default"])(this, ExprComponent);
      _this = _super.apply(this, arguments); // Opens the editor popup. Only works if expression is blank

      _this.openEditor = _this.openEditor.bind((0, _assertThisInitialized2["default"])(_this)); // Clean expression and pass up
    ...
    (0, _createClass2["default"])(ExprComponent, [{
      ...
      value: function render() {
        ...
        return new ExprElementBuilder(this.props.schema, this.props.dataSource, this.context.locale).build(expr, this.props.table, this.props.onChange ? this.handleChange : void 0, {
          types: this.props.types,
