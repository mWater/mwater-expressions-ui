var ExprComponent, ExprElementBuilder, ExprUtils, H, LinkComponent, OmniBoxExprComponent, R, React, StackedComponent, TextArrayComponent, WrappedLinkComponent, _, literalComponents,
...
module.exports = ExprComponent = (function(superClass) {
  ...
  ExprComponent.prototype.render = function() {
    return new ExprElementBuilder(this.props.schema, this.props.dataSource).build(this.props.value, this.props.table, this.props.onChange, {
...
ExprElementBuilder = (function() {
  ...
  ExprElementBuilder.prototype.buildScalar = function(expr, onChange, options) {
    var aggr, aggrElem, aggrs, innerOnChange, j, join, joinCol, joinsStr, len, ref, t;
    if (options == null) {
      options = {};
    }
    if (expr.aggr) {
    ...
    if (expr.expr && expr.expr.type === "field") {
      ...
      default:
        ...
        if (opItem.exprTypes.length > 1) {
          ...
          rhsElem = this.build(expr.exprs[1], table, rhsOnChange, {
            ...
            enumValues: this.exprUtils.getExprValues(expr.exprs[0]),
