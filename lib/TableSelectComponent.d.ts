...
export declare const TableSelectComponent: (props: {
    ...
    /** Some table select components (not the default) can also perform filtering. Include these props to enable this */
    filter?: import("mwater-expressions").LiteralExpr | import("mwater-expressions").FieldExpr | import("mwater-expressions").OpExpr | import("mwater-expressions").IdExpr | import("mwater-expressions").ScalarExpr | import("mwater-expressions").CaseExpr | import("mwater-expressions").ScoreExpr | import("mwater-expressions").BuildEnumsetExpr | import("mwater-expressions").VariableExpr | import("mwater-expressions").OldSpatialJoinExpr | import("mwater-expressions").ExtensionExpr | import("mwater-expressions").LegacyComparisonExpr | import("mwater-expressions").LegacyLogicalExpr | import("mwater-expressions").LegacyCountExpr | null | undefined;
