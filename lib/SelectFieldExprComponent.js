...
module.exports = SelectFieldExprComponent = function () {
  ...
  function (_React$Component) {
    ...
    function SelectFieldExprComponent(props) {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(SelectFieldExprComponent).call(this, props));
      _this.handleSearchTextChange = _this.handleSearchTextChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))); // Handle a selection in the scalar expression tree. Called with { table, joins, expr }

      _this.handleTreeChange = _this.handleTreeChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.state = {
        searchText: ""
      };
      return _this;
