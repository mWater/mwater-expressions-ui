...
module.exports = IdLiteralComponent = function () {
  ...
  function (_AsyncLoadComponent) {
    ...
    function IdLiteralComponent() {
      ...
      _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(IdLiteralComponent).apply(this, arguments));
      _this.handleChange = _this.handleChange.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      _this.loadOptions = _this.loadOptions.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      return _this;
    }
    ...
    (0, _createClass2.default)(IdLiteralComponent, [{
      ...
      value: function load(props, prevProps, callback) {
        ...
        labelExpr = this.getLabelExpr(); // select <label column> as value from <table> where <label column> ~* 'input%' limit 50
      ...
      value: function loadOptions(input, cb) {
        var idColumn, labelExpr, query, table;
        boundMethodCheck(this, IdLiteralComponent); // If no input
