...
module.exports = LocalizedStringEditorComp = function () {
  var LocalizedStringEditorComp = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(LocalizedStringEditorComp, _React$Component);

    var _super = _createSuper(LocalizedStringEditorComp);
    ...
    function LocalizedStringEditorComp(props) {
      ...
      _this.handleChangeValue = _this.handleChangeValue.bind((0, _assertThisInitialized2["default"])(_this));
      _this.onLanguageSelectionClick = _this.onLanguageSelectionClick.bind((0, _assertThisInitialized2["default"])(_this));
      _this.state = {
