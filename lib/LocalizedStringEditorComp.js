    ...
    render() {
        ...
        return R("div", { className: "input-group" }, this.props.multiline
            ...
            : R("input", {
                ...
                value: currentText,
                placeholder
            }), R("div", { className: "" }, R("button", { type: "button", className: "btn btn-secondary dropdown-toggle", "data-toggle": "dropdown" }, this.state.selectedLanguageCode), R("ul", { className: "dropdown-menu" }, lodash_1.default.map(availableLanguages, (availableLanguage) => {
