...
module.exports = ScalarExprTreeComponent = function () {
  var ScalarExprTreeComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(ScalarExprTreeComponent, _React$Component);

    var _super = _createSuper(ScalarExprTreeComponent);
...
ScalarExprTreeTreeComponent = function () {
  var ScalarExprTreeTreeComponent = /*#__PURE__*/function (_React$Component2) {
    (0, _inherits2["default"])(ScalarExprTreeTreeComponent, _React$Component2);

    var _super2 = _createSuper(ScalarExprTreeTreeComponent);
...
ScalarExprTreeLeafComponent = function () {
  var ScalarExprTreeLeafComponent = /*#__PURE__*/function (_React$Component3) {
    (0, _inherits2["default"])(ScalarExprTreeLeafComponent, _React$Component3);

    var _super3 = _createSuper(ScalarExprTreeLeafComponent);
...
ScalarExprTreeNodeComponent = function () {
  var ScalarExprTreeNodeComponent = /*#__PURE__*/function (_React$Component4) {
    (0, _inherits2["default"])(ScalarExprTreeNodeComponent, _React$Component4);

    var _super4 = _createSuper(ScalarExprTreeNodeComponent);
    ...
    function ScalarExprTreeNodeComponent(props) {
      ...
      _this2.handleArrowClick = _this2.handleArrowClick.bind((0, _assertThisInitialized2["default"])(_this2));
      _this2.handleItemClick = _this2.handleItemClick.bind((0, _assertThisInitialized2["default"])(_this2));
      _this2.state = {
