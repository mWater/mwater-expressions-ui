...
ScalarExprTreeLeafComponent = (function(superClass) {
  ...
  ScalarExprTreeLeafComponent.prototype.render = function() {
    ...
    }, this.props.item.name, this.props.item.desc ? H.span({
...
ScalarExprTreeNodeComponent = (function(superClass) {
  ...
  ScalarExprTreeNodeComponent.prototype.render = function() {
    ...
    }, this.props.item.childrenType === "section" ? H.i({
      className: "fa fa-folder-open-o",
      style: {
        paddingRight: 5
      }
    }) : void 0, this.props.item.name, this.props.item.childrenType === "join" ? H.i({
      className: "fa fa-link",
      style: {
        paddingRight: 5,
        paddingLeft: 5
      }
    }) : void 0, this.props.item.desc ? H.span({
      className: "text-muted",
      style: {
        fontSize: 12,
        paddingLeft: 3
