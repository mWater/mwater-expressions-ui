    ...
    constructor(props) {
        ...
        this.handleAddFilter = () => {
            ...
            if (this.props.value && this.props.value.op === "and") {
                this.props.onChange(update_object_1.default(this.props.value, { exprs: { $push: [null] } }));
                return;
            }
        ...
        this.handleAndChange = (i, expr) => {
            return this.handleChange(update_object_1.default(this.props.value, { exprs: { $splice: [[i, 1, expr]] } }));
        };
        this.handleAndRemove = (i) => {
            return this.handleChange(update_object_1.default(this.props.value, { exprs: { $splice: [[i, 1]] } }));
        };
        this.handleRemove = () => {
