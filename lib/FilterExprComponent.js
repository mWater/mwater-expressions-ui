...
class FilterExprComponent extends react_1.default.Component {
    constructor(props) {
        ...
        this.handleAddFilter = () => {
            ...
            if (this.props.value && this.props.value.type == "op" && this.props.value.op === "and") {
                this.props.onChange((0, immer_1.default)(this.props.value, draft => { draft.exprs.push(null); }));
                return;
            }
        ...
        this.handleAndChange = (i, expr) => {
            return this.handleChange((0, immer_1.default)(this.props.value, draft => { draft.exprs[i] = expr; }));
        };
        this.handleAndRemove = (i) => {
            return this.handleChange((0, immer_1.default)(this.props.value, draft => { draft.exprs.splice(i, 1); }));
        };
        this.handleRemove = () => {
    ...
    renderAddFilter() {
        return R("div", null, R("a", { onClick: this.handleAddFilter, className: "link-plain" }, this.props.addLabel));
    }
    render() {
