        ...
        if (expr && expr.op === "and") {
          return R('div', null, R(StackedComponent, {
            ...
            items: _.map(expr.exprs, function (subexpr, i) {
              return {
                elem: new ExprElementBuilder(_this3.props.schema, _this3.props.dataSource, _this3.context.locale, _this3.props.variables).build(subexpr, _this3.props.table, _this3.handleAndChange.bind(null, i), {
                  types: ["boolean"],
                  preferLiteral: false,
                  suppressWrapOps: ['and'] // Don't allow wrapping in and since this is an and control

                }),
                onRemove: _this3.handleAndRemove.bind(null, i)
              };
