...
module.exports = FilterExprComponent = function () {
  var FilterExprComponent = /*#__PURE__*/function (_React$Component) {
    (0, _inherits2["default"])(FilterExprComponent, _React$Component);

    var _super = _createSuper(FilterExprComponent);

    function FilterExprComponent(props) {
      var _this;

      (0, _classCallCheck2["default"])(this, FilterExprComponent);
      _this = _super.call(this, props); // Handle add filter clicked by wrapping in "and" if existing, otherwise adding a null

      _this.handleAddFilter = _this.handleAddFilter.bind((0, _assertThisInitialized2["default"])(_this)); // Clean expression and pass up

      _this.handleChange = _this.handleChange.bind((0, _assertThisInitialized2["default"])(_this)); // Handle change to a single item

      _this.handleAndChange = _this.handleAndChange.bind((0, _assertThisInitialized2["default"])(_this));
      _this.handleAndRemove = _this.handleAndRemove.bind((0, _assertThisInitialized2["default"])(_this));
        ...
        if (expr && expr.op === "and") {
          return R('div', null, R(StackedComponent, {
            ...
            items: _.map(expr.exprs, function (subexpr, i) {
              return {
                elem: new ExprElementBuilder(_this3.props.schema, _this3.props.dataSource, _this3.context.locale).build(subexpr, _this3.props.table, _this3.props.onChange ? _this3.handleAndChange.bind(null, i) : void 0, {
                  types: ["boolean"],
                  preferLiteral: false,
          ...
          }, new ExprElementBuilder(this.props.schema, this.props.dataSource, this.context.locale).build(expr, this.props.table, this.props.onChange ? this.handleChange : void 0, {
            types: ["boolean"],
            preferLiteral: false,
            suppressWrapOps: ['and'] // Don't allow wrapping in and since this is an and control
