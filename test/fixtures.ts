  ...
  schema = schema.addTable({
    ...
    contents: [
      ...
      { id: "boolean", name: { en: "Boolean" }, type: "boolean" },
      {
        ...
        name: { en: "T1->T2" },
        type: "join",
        join: { fromTable: "t1", fromColumn: "primary", toTable: "t2", toColumn: "t1", op: "=", multiple: true }
      },
  ...
  schema = schema.addTable({
    ...
    contents: [
      ...
      { id: "number", name: { en: "Number" }, type: "number" },
      {
        ...
        name: { en: "T2->T1" },
        type: "join",
        join: { fromTable: "t2", fromColumn: "t1", toTable: "t1", toColumn: "primary", op: "=", multiple: false }
      }
    ]
  })
