...
export default ExprComponent = (function() {
  ExprComponent = class ExprComponent extends React.Component {
    ...
    render() {
      ...
      return new ExprElementBuilder(this.props.schema, this.props.dataSource, this.context.locale, this.props.variables).build(expr, this.props.table, (this.props.onChange ? this.handleChange : undefined), { 
        types: this.props.types,
        ...
        exprLinkRef: !expr ? (c => { return this.exprLink = c; }) : undefined
        });
    }
  };
