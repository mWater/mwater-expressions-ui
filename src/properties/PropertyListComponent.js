...
class PropertyListComponent extends React.Component {
    ...
    return R('div', {className: "btn-group pl-controls"},
      ...
      R('ul', {className: "dropdown-menu text-left", role: "menu"},
        ...
        _.includes(this.props.features, "section") ?
          R('li', {key: "section"}, R('a', {onClick: this.handleNewSection}, "Section")) : undefined
      )
    );
  }
  ...
  render() {
    ...
    return R('div', {className: 'pl-editor-container'},
...
class PropertyComponent extends React.Component {
  ...
  renderControls() {
    return R('div', {className: "pl-item-controls"},
      ...
      R('a', {className: "pl-item-control", onClick: (() => this.props.onCopy(this.props.listId, this.props.property.id))}, "Copy"),
      R('a', {className: "pl-item-control", onClick: (() => this.props.onCut(this.props.listId, this.props.property.id))}, "Cut"),
      this.context.clipboard ?
        R('a', {className: "pl-item-control", onClick: (() => this.props.onPaste(this.props.listId, this.props.property.id))}, "Paste") : undefined,
      
      this.context.clipboard && (this.props.property.type === "section") ?  
        R('a', {className: "pl-item-control", onClick: (() => this.props.onPasteInto(this.props.listId, this.props.property.id))}, "Paste Into") : undefined,
  ...
  render() {
    ...
    return R('div', {className: `${ classNames.join(" ")} pl-item-type-${this.props.property.type}`},
      this.state.editing ?
        R(ActionCancelModalComponent, { 
          ...
          onAction: () => {
            if (this.state.editorProperty) {
              // Prevent duplicates
              if ((this.state.editorProperty.id !== this.props.property.id) && this.props.allPropertyIds.includes(this.state.editorProperty.id)) {
                return alert("Duplicate ids not allowed");
              }
      ...
      this.renderControls(),  
      this.props.property.deprecated ?
        R('div', {className: "pl-item-deprecated-overlay"}, "") : undefined,
      R('div', {className: "pl-item", onDoubleClick: this.handleEdit}, 
          ...
          R('div', null,
            R('div', {className: "pl-item-detail-name"},
              _.includes(this.props.features, "idField") && this.props.property.id ?
                R('small', null, `[${this.props.property.id}] `) : undefined,
              R(LocalizedStringComponent, {value: this.props.property.name}),
              this.props.property.required ?
                R('span', {style: { color: "red" }}, "*") : undefined,
              this.props.property.expr ?
                R('span', {className: "text-muted"},
                  " ",
                  R('span', {className: "fa fa-calculator"})) : undefined
            ),
            this.props.property.desc ?
              R('div', {className: "pl-item-detail-description"},
                R(LocalizedStringComponent, {value: this.props.property.desc})) : undefined,
            this.props.property.sql ?
              R('div', {className: "pl-item-detail-sql text-info"}, `SQL: ${this.props.property.sql}`) : undefined,
            this.props.property.reverseSql ?
              R('div', {className: "pl-item-detail-sql text-info"}, `Reverse SQL: ${this.props.property.reverseSql}`) : undefined,
            ["enum", "enumset"].includes(this.props.property.type) && (this.props.property.enumValues.length > 0) ?
              R('div', {className: "pl-item-detail-enum text-muted"}, this.renderEnumValues(this.props.property.enumValues)) : undefined,
            _.includes(this.props.features, "table") && this.props.property.table ?
              R('div', {className: "pl-item-detail-table text-muted"}, 
                this.renderTable(this.props.property.table)) : undefined,
            this.props.property.roles && this.props.createRoleDisplayElem ?
              this.props.createRoleDisplayElem(this.props.property.roles) : undefined
          )
        )
      ),
