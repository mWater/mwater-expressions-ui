    ...
    render() {
      return R('div', null,
          ...
          [
            ...
            this.props.forbiddenPropertyIds && this.props.forbiddenPropertyIds.includes(this.props.property.id) ?
              R('div', {className: "alert alert-danger"},
                "Duplicate IDs not allowed") : undefined
          ] : undefined,
        ...
        R(ui.FormGroup, {label: "Type"},
          R('select', {className: "form-control", value: this.props.property.type, onChange: (ev => this.props.onChange(_.extend({}, this.props.property, {type: ev.target.value})))},
            R('option', {key: "", value: ""}, ""),
            ...
            _.includes(this.props.features, "idType") && this.props.schema ?
              R('option', {key: "id", value: "id"}, "Reference") : undefined,
            _.includes(this.props.features, "idType") && this.props.schema ?
              R('option', {key: "id[]", value: "id[]"}, "Reference List") : undefined,
            _.includes(this.props.features, "joinType") ?
              R('option', {key: "join", value: "join"}, "Join") : undefined,
            _.includes(this.props.features, "dataurlType") ?
              R('option', {key: "dataurl", value: "dataurl"}, "Data URL (inline file storage)") : undefined
          )
        ),
        ["enum", "enumset"].includes(this.props.property.type) ?
          R(ui.FormGroup, {label: "Values"},
            R(EnumValuesEditorComponent, {value: this.props.property.enumValues, onChange: (value => this.props.onChange(_.extend({}, this.props.property, {enumValues: value})))})) : undefined,
      
        _.includes(this.props.features, "expr") && this.props.property.type && (this.props.property.table || this.props.table) ?
          R(ui.FormGroup, {label: "Expression", hint: (!this.props.property.table ? "Leave blank unless this property is an expression" : undefined)}, 
            R(ExprComponent, { 
        ...
        ["id", "id[]"].includes(this.props.property.type) ?
          R(ui.FormGroup, {label: "ID Table"},
            R(TableSelectComponent, {value: this.props.property.idTable, schema: this.props.schema, onChange: (table => this.props.onChange(_.extend({}, this.props.property, {idTable: table})))})) : undefined,
      
        _.includes(this.props.features, "required") ?
          R(ui.Checkbox, {value: this.props.property.required, onChange: (value => this.props.onChange(_.extend({}, this.props.property, {required: value})))},
            "Required") : undefined,
        ...
        _.includes(this.props.features, "uniqueCode") && (this.props.property.type === "text") ?
          R(ui.Checkbox, {value: this.props.property.uniqueCode, onChange: (value => this.props.onChange(_.extend({}, this.props.property, {uniqueCode: value})))},
            "Unique Code") : undefined,

        _.includes(this.props.features, "unique") && ["text", "id"].includes(this.props.property.type) ?
          R(ui.Checkbox, {value: this.props.property.unique, onChange: (value => this.props.onChange(_.extend({}, this.props.property, {unique: value})))},
            "Unique Value") : undefined,

        _.includes(this.props.features, "indexed") && ["text", "id", "number", "enum"].includes(this.props.property.type) ?
          R(ui.Checkbox, {value: this.props.property.indexed, onChange: (value => this.props.onChange(_.extend({}, this.props.property, {indexed: value})))},
            "Indexed (improves query speed, but slows updates)") : undefined,
        ...
        _.includes(this.props.features, "onDelete") && ["id"].includes(this.props.property.type) ?
          R(ui.FormGroup, {label: "On Delete"},
            R(ui.Select, { 
              ...
              nullLabel: "No Action",
              onChange: (value => this.props.onChange(_.extend({}, this.props.property, {onDelete: value || undefined}))),
              options: [
        ...
        _.includes(this.props.features, "sql") ?
          R(ui.FormGroup, {label: "SQL", hint: "Use {alias} for the table alias"},
            R('input', {type: 'text', className: "form-control", value: this.props.property.sql, onChange: (ev => this.props.onChange(_.extend({}, this.props.property, {sql: ev.target.value})))})) : undefined,

        _.includes(this.props.features, "reverseSql") ?
          R(ui.FormGroup, {label: "Reverse SQL", hint: "Use {value} for the value to convert"},
            R('input', {type: 'text', className: "form-control", value: this.props.property.reverseSql, onChange: (ev => this.props.onChange(_.extend({}, this.props.property, {reverseSql: ev.target.value})))})) : undefined,

        this.props.createRoleEditElem ?
          R(ui.FormGroup, {label: "Roles"},
            this.props.createRoleEditElem(this.props.property.roles || [], roles => this.props.onChange(_.extend({}, this.props.property, {roles})) )) : undefined
      );
    }
  };
...
class TableSelectComponent extends React.Component {
  ...
  render() {
    const options = _.sortBy(_.map(this.props.schema.tables, table => ({ value: table.id, label: table.name[table.name._base || "en"] + " - " + table.id })), "value");
    return R(ui.Select, { 
...
class EnumValuesEditorComponent extends React.Component {
  ...
  render() {
    ...
    return R('div', null,
      ...
      R('button', {type: "button", className: "btn btn-link", onClick: this.handleAdd},
        "+ Add Value")
    );
  }
}
      ...
      R('div', {className: "panel-body"},
        ...
        R('div', {className: "row"},
          R('div', {className: "col-md-12"},
            R(ui.FormGroup, {label: "Name"},
              R(LocalizedStringEditorComp, {value: this.props.value.name, onChange: value => this.props.onChange(_.extend({}, this.props.value, {name: value}))}))
          )
        ),
        R('div', {className: "row"},
          R('div', {className: "col-md-12"},
            R(ui.FormGroup, {label: "Description"},
              R(LocalizedStringEditorComp, {value: this.props.value.desc, onChange: value => this.props.onChange(_.extend({}, this.props.value, {desc: value}))}))
          )
        ),
        R('div', {className: "row", style: { float: "right" }},
          this.props.onMoveUp ?
            R('button', {className: "btn btn-link btn-xs", onClick: this.props.onMoveUp}, 
              "Move Up") : undefined,
          this.props.onMoveDown ?
            R('button', {className: "btn btn-link btn-xs", onClick: this.props.onMoveDown}, 
              "Move Down") : undefined,
          this.props.onRemove ?
            R('button', {className: "btn btn-link btn-xs", onClick: this.props.onRemove}, 
              "Remove") : undefined
        )
      )
    );
