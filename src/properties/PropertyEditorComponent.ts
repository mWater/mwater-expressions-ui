...
import { Column, DataSource, EnumValue, Expr, ExprUtils, LiteralType, Schema, Section, Variable } from "mwater-expressions"
...
export default class PropertyEditorComponent extends React.Component<PropertyEditorComponentProps> {
  ...
  render() {
    ...
    return R(
      ...
      _.includes(features, "expr") &&
        ...
        ? R(
            ...
            R(ExprComponent, {
              ...
              value: this.props.property.expr ?? null,
              types: [this.props.property.type as LiteralType],
      ...
      _.includes(features, "conditionExpr") && (this.props.property.table || this.props.table)
        ? R(
            ...
            R(ExprComponent, {
              ...
              dataSource: this.props.dataSource!,
              table: this.props.property.table || this.props.table,
              value: this.props.property.conditionExpr ?? null,
              types: ["boolean"],
              variables: this.props.variables,
      ...
      this.props.property.type === "join" && (this.props.property.table || this.props.table)
        ? R(
            ui.FormGroup,
            { label: "Join" },
