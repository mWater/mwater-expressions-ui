...
export default InlineExprsEditorComponent = (function() {
  InlineExprsEditorComponent = class InlineExprsEditorComponent extends React.Component {
    ...
    renderInsertModal() {
      return R(ExprInsertModalComponent, {ref: (c => { return this.insertModal = c; }), schema: this.props.schema, dataSource: this.props.dataSource, table: this.props.table, onInsert: this.handleInsert});
    }

    renderUpdateModal() {
      return R(ExprUpdateModalComponent, {ref: (c => { return this.updateModal = c; }), schema: this.props.schema, dataSource: this.props.dataSource, table: this.props.table, onUpdate: this.handleUpdate});
    }
      ...
      return R('div', {style: { position: "relative" }},
        ...
        R('div', {style: { paddingRight: 20 }},
          R(ContentEditableComponent, { 
            ref: c => { return this.contentEditable = c; }, 
            html: this.createContentEditableHtml(), 
            style: { whiteSpace: 'pre-wrap', padding: "6px 12px", border: "1px solid #ccc", borderRadius: 4, minHeight: (this.props.multiline && this.props.rows ? `${this.props.rows * 2.5}ex` : undefined) },
            onChange: this.handleChange,
            onClick: this.handleClick
          }
          )
        ),
        R('a', {onClick: this.handleInsertClick, style: { cursor: "pointer", position: "absolute", right: 5, top: 8, fontStyle: "italic", color: "#337ab7" }},
          "f",
          R('sub', null, "x"))
      );
    }
